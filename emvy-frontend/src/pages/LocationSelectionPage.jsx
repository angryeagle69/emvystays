...
const LocationSelectionPage = ({ onNext, onBack }) => {
  const [selectedLocation, setSelectedLocation] = useState('');
  const navigate = useNavigate();

  const locations = [
    'Bandra', 'Andheri', 'Juhu',
    'Colaba', 'Marine Drive', 'Powai',
    'Malabar Hills', "Versova", 
    "I'm flexible"
  ];
            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-800">Choose Your Neighborhood</h3>
                ...
                <div className="space-y-4">
                  <div className="text-center">
                    <p className="text-sm text-gray-600">
                      {selectedLocation ? '1 location selected' : '0 locations selected'}
                    </p>
                  </div>
                  
                  {/* Progress Bar */}
                  <div className="w-full bg-gray-200 rounded-full h-1">
                    <div className="bg-orange-500 h-1 rounded-full w-1/4 transition-all duration-500 ease-in-out"></div>
                  </div>
                </div>
